...
OUTPUT_PATH = f"backend/results/{VIDEO_ID}_step2.json"
...
def main():
    ...
    print(f"--- Running Step 2 LLM Correction for {VIDEO_ID} ---")
    
    # Run paragraph splitting and correction
    # Note: We use gpt-4o-mini as configured in processor.py
    ...
    print(f"--- Step 2 result saved to {OUTPUT_PATH} ---")
