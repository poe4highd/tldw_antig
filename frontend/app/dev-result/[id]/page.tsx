                        ...
                        {result.youtube_id ? (
                            ...
                            result.media_path?.match(/\.(mp4|mov|webm|mkv)$/i) ? (
                                ...
                                <div className="w-full h-full flex flex-col">
                                    <div className="flex-1 flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: result.thumbnail?.startsWith('#') ? result.thumbnail : '#1e293b' }}>
