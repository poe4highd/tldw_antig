                        ...
                        <section>
                            ...
                            <div className="bg-slate-900/40 border border-slate-800/50 backdrop-blur-md rounded-3xl p-8 space-y-6">
                                <div className="flex items-center space-x-6">
                                    ...
                                    />
                                    <div>
                                        <h3 className="text-xl font-bold">{user?.user_metadata?.full_name || t("settings.defaultUser")}</h3>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        >
                                            ...
                                            <div className="text-xs font-medium opacity-60">{t("settings.gridDesc")}</div>
                                        </button>
                                        <button
                                        ...
                                        >
                                            ...
                                            <div className="text-xs font-medium opacity-60">{t("settings.listDesc")}</div>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-900/40 border border-slate-800/50 backdrop-blur-md rounded-3xl p-8">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 mt-1 font-medium">{t("settings.googleAuthDesc")}</p>
                                    </div>
